...
public class DataValidator {
	...
	public static boolean isSunday(String val) {
		...
		System.out.println("i is printing :-" + i);
	...
	public static void main(String[] args) {
		...
		// Test isSunday
		System.out.println("\nisSunday Test:");
		System.out.println("Date on Sunday: '10/13/2024' -> " + isSunday("02-12-2024"));
		System.out.println("Date not on Sunday: '10/15/2024' -> " + isSunday("11-10-2025"));
	}
}