...
/**
 * FrontCtl performs the session checking and logging operations before calling
 * any other application controller It's also prevents user from access
...
public class FrontController implements Filter {
	...
	/**
	 * Performs filtering by checking session validity. If user is not logged in,
