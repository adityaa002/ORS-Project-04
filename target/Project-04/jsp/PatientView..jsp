...
<body>
	...
	<%
		List<PatientBean> diseaseList = (List<PatientBean>) request.getAttribute("diseaseList");
		...
		<div align="center">
			...
			<table>
				...
				<tr>
					...
					<td><%=HTMLUtility.getList("disease", DataUtility.getStringData(bean.getDisease()), diseaseList)%>
					</td>
